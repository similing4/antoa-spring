...
public class ListFilterStartTime extends ListFilterBase {

	private static final long serialVersionUID = 4576371054231528067L;
    public String type = "ListFilterStartTime";

	public ListFilterStartTime(String col, String tip) {
		super(col, tip);
		// TODO Auto-generated constructor stub
	}
	
	public ListFilterStartTime(String col, String tip, String defaultVal) {
	...
	public void onFilter(DBListOperator gridListDbObject, UrlParamCalculator urlParamCalculator, String uid) {
        UrlParamCalculatorParamItem param = urlParamCalculator.getPageParamByKey(this.col + "_starttime");
