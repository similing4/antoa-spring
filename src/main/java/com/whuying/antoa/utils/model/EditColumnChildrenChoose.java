...
public class EditColumnChildrenChoose extends EditColumnBase {
	private static final long serialVersionUID = 7545815637862197386L;
	/**
     * 用于选择的GridList实例
     */
    ...
    public String type = "EditColumnChildrenChoose";
     ...
     */
    public EditColumnChildrenChoose(String col, String tip, GridListEasy gridListEasy, String gridListVModelCol, String gridListDisplayCol) {
     ...
     */
    public EditColumnChildrenChoose(String col, String tip, GridListEasy gridListEasy, String gridListVModelCol, String gridListDisplayCol, String defaultVal) {
    ...
    public JSONObject jsonSerialize() {
    	...
    	ret.put("gridListEasy", this.gridListEasy);
    	ret.put("gridListVModelCol", this.gridListVModelCol);
    	ret.put("gridListDisplayCol", this.gridListDisplayCol);
    	return ret;
    }
