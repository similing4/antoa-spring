 ...
 * 描述: 列表页头部按钮实体类
 */
public abstract class ListHeaderButtonBase implements Serializable {
	private static final long serialVersionUID = -6948980634021276992L;
     ...
     */
    public ListHeaderButtonBase(String baseUrl, String buttonText) {
     ...
     * @param String buttonType 按钮类型
     */
    public ListHeaderButtonBase(String baseUrl, String buttonText, String buttonType) {
